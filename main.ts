...
import { DEFAULT_SETTINGS, type WordCountPluginSettings } from './src/settings/types';
...
import { WordCountSettingTab } from './src/settings/tab';
import type { AppWithInternals } from './src/obsidian-internals';
