import { App, ButtonComponent, DropdownComponent, Editor, EditorPosition, MarkdownView, Notice, Platform, Plugin, PluginSettingTab, Setting, TextComponent, ToggleComponent } from 'obsidian';
import { DEFAULT_SETTINGS, DEFAULT_WORD_REGEX, type WordCountPluginSettings } from './src/settings/types';
import { type WordCountHistoryEntry } from './src/types';
...
import { countSelectedWords } from './src/counting/words';
import { countSelectedText } from './src/counting/index';
import { WordCountModal } from './src/ui/modal';
